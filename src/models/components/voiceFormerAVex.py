...
from src.models.components.LearnableSTFT import CustomCNNLayer
...
class VoiceFormerAVex(nn.Module):
    """ 
    ...
    def __init__(self,
        ...
        self.adaptive_layer = CustomCNNLayer(video_chin, chin,8,16)
