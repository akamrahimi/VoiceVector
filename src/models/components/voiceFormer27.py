...
from src.models.components.refinenet import RefineNet
...
class VoiceFormer27(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_decoder_layers = 6,  # number of nn.TransformerDecoderLayer in nn.TransformerDecoder
        ...
        self.transformer = TransformerModel(chin, chin, 8, 768, 3)
