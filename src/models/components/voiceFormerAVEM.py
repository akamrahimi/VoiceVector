...
from src.models.components.EmbeddingAV2 import EmbeddingAV
...
class VoiceFormerAVEM(nn.Module):
    """
    ...
    def __init__(self,
        ...
        self.audio_video_embedding = EmbeddingAV()
        self.transformer = TransformerModel(chin, chin, num_heads, d_hid, num_encoder_layers)
    
    def forward(self, mixture, audios, video_features, speaker_embedding=None, emmbeding_ids=None):
        ...
        return self.step(mixture, audios, video_features, emmbeding_ids) 
    
    def step(self, mixture, audios, video_features, emmbeding_ids):        
        ...
        with th.no_grad():
            ...
            if self.normalize:
                ...
                mixture = mixture / (self.floor + std)
            else:
                std = 1
        ...
        feat = self.audio_video_embedding(audios, video_features).permute(0, 2, 1)
