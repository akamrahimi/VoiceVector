...
from .components.LibiriSpeechDataset import LibiriSpeech

class LibriSpeechDataModule(LightningDataModule):
    """LightningDataModule for Libirispeech dataset.
    ...
    def prepare_data(self):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            train_set = LibiriSpeech(self.hparams.data_root,
            ...
            val_set = LibiriSpeech(self.hparams.data_root,
                             self.hparams.audio_root,
                             self.hparams.speaker_emb_root,
                             self.hparams.background_noise_root,
                             train='val', 
            ...
            tests_set = LibiriSpeech(self.hparams.data_root,
                             self.hparams.audio_root,
                             self.hparams.speaker_emb_root,
                             self.hparams.background_noise_root,
                             train='test', 
